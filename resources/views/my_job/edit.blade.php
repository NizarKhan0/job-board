        ...
        <form action="{{ route('my-jobs.update', $work) }}" method="POST">
            ...
            <div class="mb-4 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <x-radio-group name="experience" :value="$work->experience" :all-option="false" :options="array_combine(
                ...
                <div>
                    ...
                    <x-radio-group name="category" :all-option="false" :value="$work->category" :options="\App\Models\Work::$category" />
                </div>
